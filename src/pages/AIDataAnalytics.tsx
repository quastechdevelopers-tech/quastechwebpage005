...
const AIDataAnalytics = () => {
  ...
  const modules = [
    { title: "AI Basics", topics: ["Machine Learning", "NLP", "Computer Vision", "AI Models"] },
    { title: "Data Analytics", topics: ["Statistical Analysis", "Data Visualization", "Predictive Analytics", "Big Data"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="AI & Data Analytics Course" description="Master AI and Data Analytics with machine learning, NLP, computer vision." keywords="AI course, data analytics, artificial intelligence" canonical="/ai-data-analytics" ogImage="/images/Data-Science-With-Python.png" category="IT Courses" />
      <CourseStructuredData name="AI & Data Analytics" description="AI and analytics training." url="https://quastech.co.in/ai-data-analytics" duration="P6M" courseMode="blended" image="https://quastech.co.in/images/Data-Science-With-Python.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "AI & Data Analytics", url: "/ai-data-analytics" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><h1 className="text-5xl font-bold">AI & Data Analytics</h1><p className="text-xl">Transform data into intelligent insights</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
        ...
        <CourseTechnologySection courseSlug="ai-data-analytics" />
        <BranchSection />
        <Footer />
      </div>
    </DarkModeProvider>
