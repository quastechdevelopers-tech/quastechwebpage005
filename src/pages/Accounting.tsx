...
I am interested in booking a free counselling session. Please contact me at your earliest convenience.`;
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Accounting Training Course with Placement"
        description="Master Accounting with comprehensive training in Bookkeeping, Journal Entries, Ledger, Trial Balance, Bank Reconciliation, Accounts Payable/Receivable, and Financial Statements. Get hands-on experience with real accounting projects and 100% placement assistance at QUASTECH."
        keywords="accounting course, bookkeeping training, journal entries, ledger, trial balance, accounts payable receivable, payroll accounting, accounting certification, placement guarantee"
        canonical="/accounting"
        ogImage="/images/accounting/accounting.png"
        category="Non-IT Courses"
      />
      <CourseStructuredData 
        name="Accounting Training Course"
        description="Complete Accounting training covering Accounting Fundamentals, Bookkeeping Principles, Chart of Accounts, Journal Entries, Bank Reconciliation, Inventory Management, and Financial Statements with guaranteed placement support."
        url="https://quastech.co.in/accounting"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/accounting/accounting.png"
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Accounting</span>
                </motion.div>
                ...
                >
                  Master Accounting with comprehensive training in Bookkeeping, Journal Entries, Ledger Management, Trial Balance, Bank Reconciliation, and Financial Statements. Start your accounting career with expert guidance.
                </motion.p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Accounting Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers fundamentals of accounting, financial statements, bookkeeping, journal entries, ledgers, trial balance, Tally ERP, GST, income tax basics, and practical accounting practices.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to video lectures, practice exercises, accounting templates, study materials, and sample financial statements.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 10-12 weeks. Classes are scheduled on weekdays/weekends with practical exercises, case studies, and dedicated support for accounting concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No prior accounting knowledge required. We start from basics. Suitable for students, career switchers, business owners, and professionals seeking accounting skills.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
