...
const AngularTraining = () => {
  ...
  // Angular Development Curriculum Modules - 20 weeks (5 Months)
  const curriculumModules = [
    ...
    {
      id: "module-8",
      title: "Angular Capstone Project",
      category: "#Project",
      duration: "1 Week",
      topics: [
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Angular Course - Angular Development Training"
        description="Learn Angular framework with hands-on training in TypeScript, Components, Services, RxJS, and modern Angular architecture. Build enterprise applications with placement assistance."
        keywords="angular course, angular training, angular certification, typescript training, angular developer, frontend framework, angular programming"
        canonical="/angular-course"
        ogImage="/images/course images/angular.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Angular Course"
        description="Complete Angular training covering TypeScript, Components, Services, RxJS, NgRx, and modern Angular development for enterprise applications."
        url="https://quastech.co.in/angular-course"
        duration="P3M"
        courseMode="blended"
        image="https://quastech.co.in/images/course images/angular.png"
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Angular Development</span>
                </motion.div>
                ...
                >
                  Master Angular framework and build scalable enterprise applications. Learn TypeScript, components, services, RxJS, routing, and create powerful single-page applications.
                </motion.p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Angular Development Training program equips you to build robust, scalable single-page applications using TypeScript, Angular components, RxJS, routing, forms, and best practices.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Component Architecture", desc: "Design reusable, modular Angular components" },
                { icon: Code, title: "TypeScript & RxJS", desc: "Write type-safe code and handle async streams" },
                { icon: TrendingUp, title: "Routing & State", desc: "Implement navigation, guards, and NgRx patterns" },
                { icon: Star, title: "Testing & Performance", desc: "Unit/E2E testing, optimization, and accessibility" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Angular Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Angular Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers Angular fundamentals, TypeScript, components, directives, services, dependency injection, routing, forms, RxJS, HTTP clients, state management, and building enterprise Angular applications.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to Angular project source code, video lectures, TypeScript materials, coding exercises, and assignments.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 8-12 weeks. Classes are scheduled on weekdays/weekends with hands-on coding sessions, project building, and dedicated support for Angular development.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic HTML, CSS, and JavaScript knowledge is recommended. We cover TypeScript basics and gradually progress to Angular. Suitable for web developers and frontend enthusiasts.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Angular Training.
              </p>
