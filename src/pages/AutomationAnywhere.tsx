...
const AutomationAnywhere = () => {
  ...
  const modules = [
    { title: "AA Basics", topics: ["Bot Development", "Variables", "Commands", "Control Room"] },
    { title: "Enterprise RPA", topics: ["MetaBots", "IQ Bot", "Bot Deployment", "Security"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="Automation Anywhere Course" description="Learn Automation Anywhere for RPA development." keywords="automation anywhere, RPA course" canonical="/automation-anywhere" ogImage="/images/RAP-traning.png" category="IT Courses" />
      <CourseStructuredData name="Automation Anywhere" description="Enterprise automation platform." url="https://quastech.co.in/automation-anywhere" duration="P3M" courseMode="blended" image="https://quastech.co.in/images/RAP-traning.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "Automation Anywhere", url: "/automation-anywhere" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><h1 className="text-5xl font-bold">Automation Anywhere</h1><p className="text-xl">Enterprise automation platform</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
