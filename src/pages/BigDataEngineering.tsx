...
const BigDataEngineering = () => {
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Big Data Engineering Training Course with Placement"
        description="Master Big Data Engineering with Hadoop, Spark, Hive, Kafka, and data processing frameworks. Build scalable data solutions with hands-on training and 100% placement assistance at QUASTECH."
        keywords="big data course, hadoop training, spark training, big data engineering, data processing, hive, kafka, big data certification, placement guarantee"
        canonical="/big-data-engineering"
        ogImage="/images/bigdata/big-data-engineering.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Big Data Engineering Course"
        description="Complete Big Data Engineering training covering Hadoop, Spark, Hive, Kafka, data pipelines with hands-on projects and guaranteed placement support."
        url="https://quastech.co.in/big-data-engineering"
        duration="P5M"
        courseMode="blended"
        image="https://quastech.co.in/images/bigdata/big-data-engineering.png"
      />
      <BreadcrumbStructuredData 
        items={[
          { name: "Home", url: "/" },
          { name: "IT Courses", url: "/#courses" },
          { name: "Big Data Engineering", url: "/big-data-engineering" }
        ]}
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Big Data Engineering</span>
                </motion.div>
                ...
                >
                  Master Big Data Engineering with Hadoop, Spark, Hive, Kafka, and modern data processing frameworks. Build scalable data pipelines and analytics solutions for enterprise-level data challenges.
                </motion.p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Big Data Engineering Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers Hadoop, Spark, Hive, Kafka, data pipelines, ETL processes, data warehousing, cloud platforms (AWS/Azure), real-time data processing, and hands-on big data projects.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to big data project code, video lectures, Hadoop/Spark setups, datasets, and assignments.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 12-16 weeks. Classes are scheduled on weekdays/weekends with hands-on labs, real-world data projects, and dedicated support for big data concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic programming knowledge (Java/Python) and SQL is recommended. Suitable for IT professionals, data engineers, and those transitioning to big data technologies.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
