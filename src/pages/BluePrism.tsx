...
const BluePrism = () => {
  ...
  const modules = [
    { title: "Blue Prism Basics", topics: ["Process Studio", "Object Studio", "Work Queues", "Processes"] },
    { title: "Enterprise Automation", topics: ["Control Room", "Release Management", "Security", "Best Practices"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="Blue Prism Course" description="Master Blue Prism for intelligent automation." keywords="blue prism, intelligent automation, RPA training" canonical="/blue-prism" ogImage="/images/RAP-traning.png" category="IT Courses" />
      <CourseStructuredData name="Blue Prism" description="Intelligent digital automation." url="https://quastech.co.in/blue-prism" duration="P3M" courseMode="blended" image="https://quastech.co.in/images/RAP-traning.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "Blue Prism", url: "/blue-prism" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><h1 className="text-5xl font-bold">Blue Prism</h1><p className="text-xl">Intelligent digital automation</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
