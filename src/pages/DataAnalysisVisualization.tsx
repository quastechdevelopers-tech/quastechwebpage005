...
📚 *Course Page:* Data Analysis & Visualization
...
I am interested in booking a free counselling session. Please contact me at your earliest convenience.`;
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Data Analysis & Visualization Training Course with Placement"
        description="Master Data Analysis & Visualization with comprehensive training in Python, Pandas, NumPy, Tableau, Power BI, and Data Science tools. Get hands-on experience with real datasets and 100% placement assistance at QUASTECH."
        keywords="data analysis course, data visualization training, python pandas, tableau power BI, business intelligence, data science course, placement guarantee"
        canonical="/data-analysis-visualization"
        ogImage="/images/data-analysis/data-analysis-visualization.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Data Analysis & Visualization Training Course"
        description="Complete Data Analysis & Visualization training covering Python for Data Analysis, Pandas/NumPy, Statistical Analysis, Tableau, Power BI, and Advanced Analytics with guaranteed placement support."
        url="https://quastech.co.in/data-analysis-visualization"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/data-analysis/data-analysis-visualization.png"
      />
      <BreadcrumbStructuredData 
        items={[
          { name: "Home", url: "/" },
          { name: "IT Courses", url: "/#courses" },
          { name: "Data Analysis & Visualization", url: "/data-analysis-visualization" }
        ]}
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Data Analysis & Visualization</span>
                </motion.div>
                ...
                >
                  Data Analysis & Visualization Training Program
                </motion.h1>
                ...
                >
                  Master Data Analysis and Visualization with Python, Pandas, Tableau, and Power BI. Transform raw data into actionable business insights with expert guidance.
                </motion.p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Data Analysis & Visualization Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers Excel, SQL, Power BI, Tableau, data cleaning, statistical analysis, dashboard creation, data storytelling, and building insightful visualizations for business decision-making.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to datasets, dashboard templates, video tutorials, study materials, and hands-on analysis projects.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 10-14 weeks. Classes are scheduled on weekdays/weekends with hands-on data projects, real-world case studies, and dedicated support for analytics concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No coding required. Basic Excel knowledge is helpful. Suitable for business analysts, professionals, students, and anyone wanting to make data-driven decisions.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
