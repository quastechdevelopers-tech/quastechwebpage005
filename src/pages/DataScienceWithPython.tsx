...
const DataScienceWithPython = () => {
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Data Science with Python Course - Machine Learning Training"
        description="Master Data Science with Python - comprehensive training in Python, Machine Learning, Data Analysis, AI, TensorFlow, and Big Data. Get certified and land high-paying data science jobs with 100% placement support."
        keywords="data science course, python for data science, machine learning training, AI course, data analytics, TensorFlow training, big data course, data scientist certification"
        canonical="/python-data-science"
        ogImage="/images/Data-Science-With-Python.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Data Science with Python Course"
        description="Complete Data Science training covering Python programming, Statistics, Machine Learning, Deep Learning, AI, Data Visualization with guaranteed placement in top companies."
        url="https://quastech.co.in/python-data-science"
        duration="P6M"
        courseMode="blended"
        image="https://quastech.co.in/images/Data-Science-With-Python.png"
      />
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">6 Months</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Data Science with Python program equips you with Python fundamentals, data analysis, machine learning, and real-world projects to build a successful career in data science.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Python Fundamentals", desc: "Master Python programming and data structures" },
                { icon: Code, title: "Data Analysis", desc: "Learn NumPy, Pandas, and data manipulation" },
                { icon: TrendingUp, title: "Machine Learning", desc: "Build ML models with Scikit-learn" },
                { icon: Star, title: "Real-World Projects", desc: "Work on industry-relevant data science projects" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in Data Science with Python Training
                </span>
              </h2>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Tools & Technologies You'll Master in Data Science with Python Training
                </span>
              </h2>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Data Science with Python Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Python Data Science Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers Python fundamentals, NumPy, Pandas, data visualization with Matplotlib & Seaborn, machine learning with Scikit-learn, SQL for data analysis, real-world projects, and career preparation for data science roles.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, the course is offered in both formats. You receive lifetime LMS access including video recordings, Jupyter notebooks, datasets, Python code repositories, and hands-on assignments for practice.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The typical duration is 12–16 weeks. Sessions are scheduled on weekdays/weekends with hands-on labs, capstone projects, and dedicated doubt-clearing sessions to ensure mastery of Python and data science concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No prior coding experience is required. The program starts with Python basics and gradually progresses to advanced data science concepts. It's designed for beginners, career switchers, and professionals looking to upskill in data science.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Data Science with Python Training.
              </p>
