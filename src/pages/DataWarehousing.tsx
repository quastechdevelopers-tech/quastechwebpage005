...
const DataWarehousing = () => {
  ...
  const modules = [
    { title: "Data Warehouse Concepts", topics: ["DW Architecture", "Dimensional Modeling", "Star Schema", "Snowflake Schema"] },
    { title: "ETL & Tools", topics: ["ETL Process", "Informatica", "Talend", "Data Quality"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="Data Warehousing Course" description="Master Data Warehousing concepts, ETL processes, dimensional modeling." keywords="data warehousing, ETL, business intelligence" canonical="/data-warehousing" ogImage="/images/big-data-enegenering--training.png" category="IT Courses" />
      <CourseStructuredData name="Data Warehousing" description="Enterprise data warehouse training." url="https://quastech.co.in/data-warehousing" duration="P4M" courseMode="blended" image="https://quastech.co.in/images/big-data-enegenering--training.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "Data Warehousing", url: "/data-warehousing" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><h1 className="text-5xl font-bold">Data Warehousing</h1><p className="text-xl">Build enterprise data warehouses</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
