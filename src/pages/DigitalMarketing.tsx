...
I am interested in booking a free counselling session. Please contact me at your earliest convenience.`;
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Digital Marketing Training Course with Placement"
        description="Master Digital Marketing with comprehensive training in SEO, Google Ads, Social Media Marketing, Content Marketing, Email Marketing, and Analytics. Get hands-on experience with real campaigns and 100% placement assistance at QUASTECH."
        keywords="digital marketing course, SEO training, google ads, social media marketing, content marketing, email marketing, digital marketing certification, placement guarantee"
        canonical="/digital-marketing"
        ogImage="/images/digital-marketing/digital-marketing.png"
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Digital Marketing Training</span>
                </motion.div>
                ...
                >
                  Master Digital Marketing with comprehensive training in SEO, Google Ads, Social Media Marketing, Content Strategy, and Analytics. Learn to create successful digital campaigns and become industry-ready with expert guidance.
                </motion.p>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Digital Marketing Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Digital Marketing Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers SEO, SEM, social media marketing, Google Ads, Facebook Ads, email marketing, content strategy, analytics, affiliate marketing, and building successful digital marketing campaigns.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to video tutorials, marketing templates, campaign examples, study materials, and practical assignments.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 10-12 weeks. Classes are scheduled on weekdays/weekends with hands-on campaigns, live projects, and dedicated support for digital marketing strategies.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No coding or technical background required. Suitable for entrepreneurs, marketers, students, business owners, and anyone interested in building a career in digital marketing.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Digital Marketing Training.
              </p>
