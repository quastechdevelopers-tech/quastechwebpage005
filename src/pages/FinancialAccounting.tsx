...
?? *Course Page:* Financial Accounting
...
I am interested in booking a free counselling session. Please contact me at your earliest convenience.`;
    ...
    if (whatsappWindow) {
      ...
      toast({ title: "?? Allow Popups", description: "Please allow popups to send your request via WhatsApp", variant: "destructive" });
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Financial Accounting Training Course with Placement"
        description="Master Financial Accounting with comprehensive training in Bookkeeping, Financial Statements, GAAP, Balance Sheet, P&L, Cash Flow, and Financial Analysis. Get hands-on experience with real accounting projects and 100% placement assistance at QUASTECH."
        keywords="financial accounting course, bookkeeping training, GAAP, financial statements, balance sheet, income statement, cash flow, accounting certification, placement guarantee"
        canonical="/financial-accounting"
        ogImage="/images/accounting/financial-accounting.png"
        category="Non-IT Courses"
      />
      <CourseStructuredData 
        name="Financial Accounting Training Course"
        description="Complete Financial Accounting training covering Double Entry Bookkeeping, Trial Balance, Financial Statements, GAAP Standards, Financial Analysis, Bank Reconciliation, and more with guaranteed placement support."
        url="https://quastech.co.in/financial-accounting"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/accounting/financial-accounting.png"
      />
      <BreadcrumbStructuredData 
        items={[
          { name: "Home", url: "/" },
          { name: "Non-IT Courses", url: "/#courses" },
          { name: "Financial Accounting", url: "/financial-accounting" }
        ]}
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Financial Accounting</span>
                </motion.div>
                ...
                >
                  Master Financial Accounting with comprehensive training in Bookkeeping, Financial Statements, GAAP Standards, Financial Analysis, and Bank Reconciliation. Build your accounting career with expert guidance.
                </motion.p>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in Software Testing Training
                </span>
              </h2>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Tools & Technologies You'll Master in Software Testing Training
                </span>
              </h2>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Financial Accounting Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers advanced accounting principles, financial statement analysis, balance sheets, profit & loss, cash flow statements, ratio analysis, auditing basics, and financial reporting standards.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to video lectures, financial analysis exercises, statement templates, study materials, and practical case studies.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 12-14 weeks. Classes are scheduled on weekdays/weekends with financial analysis projects, case studies, and dedicated support for financial accounting concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">Who can join�do I need prior accounting knowledge?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic accounting knowledge is helpful. Suitable for accounting professionals, finance students, aspiring accountants, and those seeking advanced financial accounting skills.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
