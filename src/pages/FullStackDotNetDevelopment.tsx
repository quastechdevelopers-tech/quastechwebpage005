...
const FullStackDotNetDevelopment = () => {
  ...
  const courseHighlights = [
    ...
    },
    {
      ...
      icon: Award,
      description: "Earn industry-recognized certifications aligned with the curriculum.",
    },
    {
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Full Stack .Net Development Training Course with Placement"
        description="Master Full Stack .Net Development with ASP.NET Core, C#, MVC, Entity Framework, SQL Server. Build enterprise applications with hands-on training and 100% placement assistance at QUASTECH."
        keywords="full stack dotnet course, asp.net core training, c# programming, mvc framework, entity framework, dotnet development, full stack certification, placement guarantee"
        canonical="/full-stack-dotnet-development"
        ogImage="/images/dotnet/dotnet-development.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Full Stack .Net Development Course"
        description="Complete Full Stack .Net Development training covering C#, ASP.NET Core, MVC, Entity Framework, SQL Server, Web APIs with hands-on projects and guaranteed placement support."
        url="https://quastech.co.in/full-stack-dotnet-development"
        duration="P6M"
        courseMode="blended"
        image="https://quastech.co.in/images/dotnet/dotnet-development.png"
      />
      <BreadcrumbStructuredData 
        items={[
          { name: "Home", url: "/" },
          { name: "IT Courses", url: "/#courses" },
          { name: "Full Stack .Net Development", url: "/full-stack-dotnet-development" }
        ]}
      />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10 w-full container mx-auto px-4 py-4">
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Full Stack .Net Development</span>
                </motion.div>
                ...
                >
                  Master Full Stack .Net Development with C#, ASP.NET Core, MVC, Entity Framework, and SQL Server. Build scalable enterprise applications with expert guidance and industry best practices.
                </motion.p>
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">9 Months</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Full Stack .NET Development program covers C#, ASP.NET Core, MVC, Entity Framework, and SQL Server to build scalable enterprise web applications from frontend to backend.
              </p>
            </motion.div>
            ...
            <div className="relative overflow-hidden py-8">
              ...
              >
                ...
                {[
                  ...
                  { name: "ASP.NET", logo: "/coursesicons/mysql.jpg", color: "from-indigo-500 to-indigo-600" },
                  { name: "MVC", logo: "/coursesicons/bootstrap.jpg", color: "from-green-500 to-green-600" },
                  { name: "Entity Framework", logo: "/coursesicons/css.jpg", color: "from-orange-500 to-orange-600" },
                  { name: "MySQL", logo: "/coursesicons/mysql.jpg", color: "from-blue-600 to-blue-700" },
                  { name: "HTML5", logo: "/coursesicons/html.jpg", color: "from-red-500 to-red-600" },
                  { name: "CSS3", logo: "/coursesicons/css.jpg", color: "from-blue-400 to-blue-500" },
                  { name: "Bootstrap", logo: "/coursesicons/bootstrap.jpg", color: "from-purple-500 to-purple-600" },
                  { name: "JavaScript", logo: "/coursesicons/jquery.jpg", color: "from-yellow-500 to-orange-500" },
                  { name: "jQuery", logo: "/coursesicons/jquery.jpg", color: "from-blue-500 to-blue-600" },
                  { name: "Git", logo: "/coursesicons/html.jpg", color: "from-gray-600 to-gray-700" },
                  { name: "Visual Studio", logo: "/coursesicons/python.jpg", color: "from-blue-500 to-blue-600" },
                ].map((tool, index) => (
                  <motion.div
                    key={`tool-${index}`}
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-5">
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                    >
                      SUBMIT
                    </Button>
                  </form>
       ...
       {/* Hiring Partners Section */}
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Full Stack .NET Development Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Full Stack .NET Development Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers C# fundamentals, ASP.NET Core, MVC, Web API, Entity Framework, Frontend technologies (Angular/React), SQL Server, Azure cloud services, and real-world projects for building enterprise applications.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both online and offline modes are available. You get lifetime LMS access to .NET project source code, video recordings, study materials, and hands-on assignments for practice.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program typically runs for 12-16 weeks. Classes are scheduled on weekdays/weekends with hands-on coding sessions, project work, and dedicated support for clearing doubts on .NET development concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic programming knowledge is helpful but not mandatory. We start with C# fundamentals and gradually progress to advanced .NET concepts. Beginners, graduates, and career switchers are all welcome.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-r from-blue-600  to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                Ready to Start Your .NET Journey?
              </h2>
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Full Stack .NET Development Training.
              </p>
