  ...
  return (
    <DarkModeProvider>
      <SEO 
        ...
        description="Master Full Stack Java Development with hands-on training in Core Java, Advanced Java, Spring Boot, Hibernate, React, and more. Get certified with 100% placement assistance at QUASTECH, Ahmedabad's leading IT training institute."
        keywords="full stack java development course, java full stack training, spring boot course, hibernate training, java developer course, full stack development, java certification, IT training Ahmedabad, placement guarantee"
        canonical="/full-stack-java-development"
        ogImage="/images/java development trtaning/java.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Full Stack Java Development Course"
        description="Comprehensive Full Stack Java Development training covering Core Java, Advanced Java, Spring Framework, Hibernate, React, and modern development tools. Industry-recognized certification with guaranteed placement support."
        url="https://quastech.co.in/full-stack-java-development"
        duration="P6M"
        courseMode="blended"
        image="https://quastech.co.in/images/java development trtaning/java.png"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Full Stack Java Development</span>
                </motion.div>
                ...
                >
                  Master the complete Java ecosystem from backend to frontend development. Build enterprise-grade applications with Spring, React, and modern frameworks.
                </motion.p>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 flex-wrap mb-2">
                    {[
                      ...
                      <motion.button
                        key={idx}
                        className="flex items-center gap-1 md:gap-2 bg-white/20 backdrop-blur-sm rounded-lg px-2 md:px-3 py-1 md:py-1.5 cursor-pointer hover:bg-white/30 hover:shadow-lg transition-all duration-300 border border-white/10 hover:border-white/20"
                        whileHover={{ 
                          scale: 1.05,
                          y: -2,
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-white/80 text-[10px] md:text-xs mt-1">Format</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Full Stack Java Development program covers everything from core Java to modern frameworks, preparing you for real-world development across backend and frontend.
              </p>
            </motion.div>
            ...
            <div className="relative overflow-hidden py-8">
              ...
              >
                ...
                {[
                  ...
                  { name: "React", logo: "/coursesicons/react.jpg", color: "from-blue-500 to-blue-600" },
                  { name: "Hibernate", logo: "/coursesicons/hibernate.jpg", color: "from-purple-500 to-purple-600" },
                  { name: "MySQL", logo: "/coursesicons/mysql.jpg", color: "from-indigo-500 to-indigo-600" },
                  { name: "Maven", logo: "/coursesicons/maven.jpg", color: "from-yellow-500 to-orange-500" },
                  ...
                  { name: "Jenkins", logo: "/coursesicons/jenkins.jpg", color: "from-blue-600 to-blue-700" },
                  { name: "REST API", logo: "/coursesicons/api.jpg", color: "from-orange-500 to-orange-600" },
                  { name: "AWS", logo: "/coursesicons/aws.jpg", color: "from-blue-500 to-blue-600" },
                  { name: "Kubernetes", logo: "/coursesicons/k8s.jpg", color: "from-blue-400 to-blue-500" },
                ].map((tool, index) => (
                  <motion.div
                    key={`tool-${index}`}
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Full Stack Java Development program—curriculum, format, placement, and more.
              </p>
            </motion.div>
              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic programming knowledge is helpful but not required. We start from fundamentals and gradually build to advanced concepts. If you're new to programming, we provide extra support to ensure you succeed.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                Ready to Start Your Full Stack Java Development Journey?
              </h2>
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Full Stack Java Development program.
              </p>
