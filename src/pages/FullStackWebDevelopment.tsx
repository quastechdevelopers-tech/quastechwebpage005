...
const FullStackWebDevelopment = () => {
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Full Stack Web Development Course - MERN Stack Training"
        description="Become a Full Stack Web Developer with expert training in HTML, CSS, JavaScript, React, Node.js, MongoDB, and Express. Build real-world projects and get 100% placement assistance at QUASTECH."
        keywords="full stack web development, MERN stack course, web developer training, React course, Node.js training, JavaScript bootcamp, full stack certification, placement guarantee"
        canonical="/web-development-course"
        ogImage="/images/front-end-dveleopment.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Full Stack Web Development Course"
        description="Complete Full Stack Web Development training covering HTML, CSS, JavaScript, React, Node.js, Express, MongoDB with hands-on projects and guaranteed placement support."
        url="https://quastech.co.in/web-development-course"
        duration="P5M"
        courseMode="blended"
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Full Stack Web Development program takes you from frontend to backend—HTML/CSS/JS, React, Node.js, Express, and databases—so you can build and deploy production-ready applications.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Frontend Foundations", desc: "Responsive UI with HTML, CSS, JavaScript" },
                { icon: Code, title: "React Frontend", desc: "Components, hooks, routing, and state management" },
                { icon: TrendingUp, title: "Node & APIs", desc: "Express REST APIs, auth, and database integration" },
                { icon: Star, title: "Deploy & Optimize", desc: "Version control, CI/CD, cloud deployment, performance" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in Full Stack Web Development
                </span>
              </h2>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">
                  Tools & Technologies You'll Master in Full Stack Web
                </span>
              </h2>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Full Stack Web Development Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Full Stack Web Development Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers HTML5, CSS3, JavaScript, React.js, Node.js, Express.js, MongoDB, RESTful APIs, Git/GitHub, responsive design, authentication, cloud deployment, and real-world full-stack web applications.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You receive lifetime LMS access to all video recordings, web development project source code, study materials, and hands-on assignments.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 12-16 weeks. Classes are scheduled on weekdays/weekends with hands-on coding sessions, project development, and dedicated support for web development concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No prior coding experience is required. We start with HTML/CSS basics and gradually progress to advanced web development. Perfect for beginners, students, and career switchers.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Full Stack Web Development Training.
              </p>
        ...
        <CourseTechnologySection courseSlug="web-development-course" />
        <BranchSection />
