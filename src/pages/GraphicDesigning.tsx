...
I am interested in booking a free counselling session. Please contact me at your earliest convenience.`;
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Graphic Designing Training Course with Placement"
        description="Master Graphic Design with comprehensive training in Photoshop, Illustrator, CorelDRAW, UI/UX Design, Logo Design, and Branding. Get hands-on experience with real projects and 100% placement assistance at QUASTECH."
        keywords="graphic design course, photoshop training, illustrator, coreldraw, UI/UX design, logo design, branding, graphic design certification, placement guarantee"
        canonical="/graphic-designing"
        ogImage="/images/graphic-design/graphic-designing.png"
        category="Non-IT Courses"
      />
      <CourseStructuredData 
        name="Graphic Designing Training Course"
        description="Complete Graphic Design training covering Photoshop, Illustrator, CorelDRAW, UI/UX principles, Logo Design, Typography, and Branding with hands-on projects and guaranteed placement support."
        url="https://quastech.co.in/graphic-designing"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/graphic-design/graphic-designing.png"
      />
      <BreadcrumbStructuredData 
        items={[
          { name: "Home", url: "/" },
          { name: "Non-IT Courses", url: "/#courses" },
          { name: "Graphic Designing", url: "/graphic-designing" }
        ]}
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Graphic Designing Training</span>
                </motion.div>
                ...
                >
                  Graphic Designing Training Program
                </motion.h1>
                ...
                >
                  Master Graphic Design with professional training in Photoshop, Illustrator, CorelDRAW, UI/UX Design, Logo Design, and Branding. Create stunning visual designs and launch your creative career with expert guidance.
                </motion.p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Graphic Designing Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers Adobe Photoshop, Illustrator, InDesign, Figma, logo design, branding, typography, color theory, print design, digital graphics, and building a professional design portfolio.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to design tutorials, project files, templates, resources, and hands-on design assignments.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 10-12 weeks. Classes are scheduled on weekdays/weekends with hands-on design projects, portfolio building, and dedicated support for graphic design concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No prior design or technical experience required. Perfect for creative individuals, students, aspiring designers, and anyone passionate about visual communication and creativity.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
