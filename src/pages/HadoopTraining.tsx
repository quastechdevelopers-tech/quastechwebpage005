...
const HadoopTraining = () => {
  ...
  const modules = [
    { title: "Hadoop Basics", topics: ["HDFS", "MapReduce", "YARN", "Hadoop Architecture"] },
    { title: "Hadoop Ecosystem", topics: ["Hive", "Pig", "HBase", "Sqoop"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="Hadoop Training - Big Data Development" description="Master Hadoop ecosystem including HDFS, MapReduce, Hive, Pig, and HBase." keywords="hadoop training, big data, HDFS, MapReduce, Hive" canonical="/hadoop-training" ogImage="/images/big-data-enegenering--training.png" category="IT Courses" />
      <CourseStructuredData name="Hadoop Development" description="Big data processing with Hadoop." url="https://quastech.co.in/hadoop-training" duration="P4M" courseMode="blended" image="https://quastech.co.in/images/big-data-enegenering--training.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "Hadoop", url: "/hadoop-training" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><h1 className="text-5xl font-bold">Hadoop Development</h1><p className="text-xl">Master big data processing</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
