...
const ISTQBCertification = () => {
  ...
  const courseHighlights = [
    ...
    },
    {
      ...
      icon: Award,
      description: "Earn industry-recognized ISTQB Foundation Level certification aligned with the curriculum.",
    },
    {
  ...
  // ISTQB Foundation Level v4.0.1 Curriculum Modules (Official Syllabus)
  const curriculumModules = [
    ...
    },
    {
      ...
      topics: [
        ...
        "Test Types - Functional, Non-Functional, White-box, Black-box",
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="ISTQB Certification Training Course with Placement"
        description="Master ISTQB Foundation Level certification with comprehensive training covering testing fundamentals, SDLC, test techniques, and test management. Get certified and boost your testing career at QUASTECH."
        keywords="ISTQB certification, ISTQB foundation level, software testing certification, ISTQB training, certified tester, ISTQB exam preparation, testing certification Ahmedabad"
        canonical="/istqb-certification"
        ogImage="/images/software testing/software testing.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="ISTQB Certification Training Course"
        description="Complete ISTQB Foundation Level certification training covering fundamentals of testing, testing throughout the software development lifecycle, static testing, test design techniques, test management, and tool support."
        url="https://quastech.co.in/istqb-certification"
        duration="P2M"
        courseMode="blended"
      ...
      <BreadcrumbStructuredData 
        items={[
          ...
          { name: "ISTQB Certification", url: "/istqb-certification" }
        ]}
      />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">ISTQB Certification Program</span>
                </motion.div>
                ...
                >
                  Get globally recognized ISTQB Foundation Level certification. Master testing fundamentals and advance your career as a certified testing professional.
                </motion.p>
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">40 Hrs.</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our ISTQB Certification program is designed to prepare you for the globally recognized ISTQB Foundation Level exam with comprehensive knowledge of testing fundamentals and best practices.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Testing Fundamentals", desc: "Master core testing concepts" },
                { icon: Code, title: "Test Techniques", desc: "Learn industry-standard methods" },
                { icon: TrendingUp, title: "Test Management", desc: "Understand test organization" },
                { icon: Star, title: "Global Certification", desc: "ISTQB recognized worldwide" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  ISTQB Certification Curriculum
                </span>
              </h2>
            </motion.div>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in ISTQB Certification Training
                </span>
              </h2>
        ...
        <CourseTechnologySection courseSlug="istqb-certification" />
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our ISTQB Certification Training—curriculum, exam format, certification, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the ISTQB Certification Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers all 6 chapters of ISTQB Foundation Level syllabus: Fundamentals of Testing, Testing Throughout SDLC, Static Testing, Test Design Techniques, Test Management, and Tool Support for Testing, plus extensive exam preparation with mock tests.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-2" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is the ISTQB certification exam format?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The ISTQB Foundation Level exam consists of 40 multiple-choice questions, 60 minutes duration, 65% passing score (26 out of 40 questions). The certification is globally recognized and valid for life.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The course is offered in both formats. You also receive lifetime LMS access to video lectures, study materials, sample questions, mock tests, and chapter-wise practice questions.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Typical duration is 6–8 weeks covering all 6 chapters plus exam preparation. Sessions are planned on weekdays/weekends with additional doubt-clearing sessions and practice tests.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">Who can join—do I need testing experience?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No prior testing experience is required. The ISTQB Foundation Level is designed for beginners and covers all basics. It's perfect for anyone wanting to start a career in software testing.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have earned their ISTQB certification and transformed their testing careers.
              </p>
