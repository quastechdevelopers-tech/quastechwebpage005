...
const InformationTechnologyProgramme = () => {
...
I am interested in booking a free counselling session. Please contact me at your earliest convenience.`;
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Information Technology Programme Training Course with Placement"
        description="Master Information Technology with comprehensive training in Computer Fundamentals, Operating Systems, Networking, Database Management, Web Development, System Administration, IT Security, and Cloud Computing. Get hands-on experience with real IT projects and 100% placement assistance at QUASTECH."
        keywords="IT program course, computer fundamentals training, operating systems, networking, database management, system administration, IT security, cloud computing, IT support training, placement guarantee"
        canonical="/information-technology-programme"
        ogImage="/images/it/information-technology-programme.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Information Technology Programme Training Course"
        description="Complete IT training covering Computer Fundamentals, Operating Systems, Networking, Database Management, Web Development, System Administration, IT Security, Cloud Computing, IT Support, and Troubleshooting with guaranteed placement support."
        url="https://quastech.co.in/information-technology-programme"
        duration="P18M"
        courseMode="blended"
        image="https://quastech.co.in/images/it/information-technology-programme.png"
      />
      <BreadcrumbStructuredData 
        items={[
          { name: "Home", url: "/" },
          { name: "IT Courses", url: "/#courses" },
          { name: "Information Technology Programme", url: "/information-technology-programme" }
        ]}
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Information Technology Programme</span>
                </motion.div>
                ...
                >
                  Master Information Technology with comprehensive training in Computer Fundamentals, Operating Systems, Networking, Database Management, Web Development, System Administration, IT Security, and Cloud Computing. Build your IT career with expert guidance.
                </motion.p>
