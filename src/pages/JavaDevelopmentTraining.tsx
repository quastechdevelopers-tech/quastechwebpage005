...
const JavaDevelopmentTraining = () => {
  ...
  const courseHighlights = [
    ...
    },
    {
      ...
      icon: Award,
      description: "Earn industry-recognized certifications aligned with modern Java development.",
    },
    {
  ...
  // Java Development Curriculum Modules - 26 weeks (6.5 Months)
  const curriculumModules = [
    {
      ...
      topics: [
        ...
        "Control flow, methods & packages",
        "Debugging, logging & coding best practices"
      ]
    },
    {
      id: "module-2",
    ...
    },
    {
      ...
      topics: [
        ...
        "Functional programming with lambda & Optional",
        "Multithreading, concurrency utilities & JVM tuning"
      ]
    },
    {
      id: "module-4",
      ...
      topics: [
        ...
        "JDBC connectivity & transactions",
        "Using ORM concepts & DAO patterns"
      ]
    },
    {
      id: "module-5",
    ...
    },
    {
      ...
      topics: [
        ...
        "Spring MVC architecture & validation",
    ...
    },
    {
      ...
      topics: [
        ...
        "Building RESTful APIs & validation",
        "Testing APIs with JUnit & Postman"
      ]
    },
    {
      id: "module-8",
      ...
      duration: "2 Weeks",
      topics: [
        "ORM fundamentals & entity mapping",
        "JPQL, criteria API & relationships",
    ...
    },
    {
      ...
      duration: "2 Weeks",
      topics: [
        "Build toolchain with Maven & Gradle",
        "CI/CD overview & containerization basics",
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Core Java Development Training Course - Advanced Java Programming"
        description="Learn Core Java and Advanced Java programming with hands-on training in J2EE, Servlets, JSP, JDBC, Spring, and Hibernate. Get industry certification and placement assistance."
        keywords="java training, core java course, advanced java, J2EE training, java certification, java programming course, java developer training"
        canonical="/java-training"
        ogImage="/images/course images/java.jpg"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Core Java Development Training"
        description="Complete Java Development training covering Core Java, Advanced Java, J2EE, Spring Framework, Hibernate, and enterprise application development."
        url="https://quastech.co.in/java-training"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/course images/java.jpg"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Java Development Training</span>
                </motion.div>
                ...
                >
                  Master Java programming from fundamentals to advanced concepts. Learn Core Java, Spring Boot, Hibernate, and build enterprise-level applications with expert guidance.
                </motion.p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Java Development Training program equips you with strong Core Java fundamentals, enterprise frameworks, and deployment practices so you can build scalable, production-ready applications.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Core Java Foundations", desc: "Master OOP, collections, multithreading, and error handling" },
                { icon: Code, title: "Enterprise Frameworks", desc: "Build robust services with Spring, Spring Boot, and Hibernate" },
                { icon: TrendingUp, title: "REST & Database Skills", desc: "Design REST APIs and integrate SQL/NoSQL databases" },
                { icon: Star, title: "Project Experience", desc: "Deliver end-to-end Java projects with testing and deployment" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in Java Development Training
                </span>
              </h2>
        ...
        <CourseTechnologySection courseSlug="java-training" />
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Java Development Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Java Development Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers Core Java, OOP concepts, collections framework, multithreading, JDBC, Servlets, JSP, Spring Framework, Hibernate, Maven, REST APIs, and hands-on projects for enterprise application development.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-2" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Absolutely. You receive resume polishing, mock interviews, HR preparation, and curated Java developer opportunities through our hiring partners so you can land interviews quickly.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, attend online or classroom batches. You also get lifetime LMS access with recorded sessions, Java source code, assignments, cheat sheets, and reusable boilerplates.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 12-16 weeks. Classes are scheduled on weekdays/weekends with hands-on coding practice, project work, and dedicated support for Java development concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic programming knowledge is helpful but not mandatory. We start with Java fundamentals and progress to advanced concepts. Suitable for beginners, graduates, and professionals looking to learn Java.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Java Development Training.
              </p>
