...
const MERNStackDevelopment = () => {
  ...
  const courseHighlights = [
    ...
    },
    {
      ...
      icon: Award,
      description: "Earn industry-recognized certifications aligned with MERN projects.",
    },
    {
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="MERN Stack Development Training Course with Placement"
        description="Master MERN Stack Development with MongoDB, Express.js, React, Node.js. Build full stack JavaScript applications with hands-on training and 100% placement assistance at QUASTECH."
        keywords="MERN stack course, MongoDB training, Express.js, React training, Node.js course, full stack JavaScript, MERN development, placement guarantee"
        canonical="/mern-stack-development"
        ogImage="/images/mern/mern-stack.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="MERN Stack Development Course"
        description="Complete MERN Stack Development training covering MongoDB, Express.js, React, Node.js with hands-on projects and guaranteed placement support."
        url="https://quastech.co.in/mern-stack-development"
        duration="P6M"
        courseMode="blended"
        image="https://quastech.co.in/images/mern/mern-stack.png"
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">MERN Stack Development</span>
                </motion.div>
                ...
                >
                  Master MERN Stack (MongoDB, Express.js, React, Node.js) and build powerful full stack JavaScript applications. Create modern web apps with the most in-demand tech stack in the industry.
                </motion.p>
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">7.5 Months</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our MERN Stack Development program takes you from solid JavaScript foundations to building, deploying, and scaling production-ready applications with MongoDB, Express.js, React, and Node.js.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "JavaScript Foundations", desc: "Master ES6+, TypeScript basics, asynchronous patterns, and modern tooling" },
                { icon: Code, title: "React Frontend Engineering", desc: "Build component-driven SPAs with hooks, routing, state management, and testing" },
                { icon: TrendingUp, title: "Node & Express APIs", desc: "Design secure REST/GraphQL services with authentication, caching, and performance tuning" },
                { icon: Star, title: "Deployment & DevOps", desc: "Containerize apps, automate CI/CD, and ship to cloud platforms with monitoring in place" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in MERN Stack Development Training
                </span>
              </h2>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Tools & Technologies You'll Master in MERN Stack Development Training
                </span>
              </h2>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our MERN Stack Development Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the MERN Stack Development Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers MongoDB, Express.js, React.js, Node.js, RESTful APIs, state management with Redux, authentication, deployment, and building full-stack MERN applications from scratch.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to MERN stack project code, video lectures, study materials, coding exercises, and assignments.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 12-16 weeks. Classes are scheduled on weekdays/weekends with hands-on coding sessions, project development, and dedicated support for MERN stack development.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic JavaScript knowledge is recommended. We cover MERN fundamentals and progress to advanced concepts. Suitable for web developers and aspiring full-stack developers.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our MERN Stack Development Training.
              </p>
