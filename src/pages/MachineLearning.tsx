...
const MachineLearning = () => {
  ...
  const modules = [
    { title: "ML Fundamentals", topics: ["Supervised Learning", "Unsupervised Learning", "Regression", "Classification"] },
    { title: "Advanced ML", topics: ["Neural Networks", "Deep Learning Basics", "TensorFlow", "Model Deployment"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="Machine Learning Course - AI & ML Training" description="Master Machine Learning algorithms, supervised learning, unsupervised learning, and neural networks with Python and TensorFlow." keywords="machine learning, ML course, AI training, TensorFlow" canonical="/machine-learning" ogImage="/images/Data-Science-With-Python.png" category="IT Courses" />
      <CourseStructuredData name="Machine Learning Course" description="Machine Learning training with Python and AI." url="https://quastech.co.in/machine-learning" duration="P5M" courseMode="blended" image="https://quastech.co.in/images/Data-Science-With-Python.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "Machine Learning", url: "/machine-learning" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><h1 className="text-5xl font-bold">Machine Learning</h1><p className="text-xl">Master AI and ML algorithms</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
        ...
        <CourseTechnologySection courseSlug="machine-learning" />
        <BranchSection />
        <Footer />
      </div>
    </DarkModeProvider>
