...
const ManualTesting = () => {
  ...
  // Manual Testing Curriculum Modules
  const curriculumModules = [
    ...
    {
      id: "module-3",
      title: "Software Test Life Cycle (STLC)",
    ...
    },
    {
      ...
      topics: [
        ...
        "Defect Management & Dashboards",
        "Sprint Planning & Backlog Grooming",
        "Xray Installation & Configuration",
        "Test Case, Test Set & Test Plan Management",
        "Traceability, Reports & Metrics"
      ]
    },
    {
      id: "module-9",
      ...
      topics: [
        ...
        "Postman Setup & Collections",
        "Creating Requests & Managing Payloads",
    ...
    },
    {
      ...
      topics: [
        ...
        "JMeter Installation & UI Walkthrough",
        "Test Plan & Thread Group Design",
        "Samplers, Controllers & Listeners",
        "Assertions & Timers",
        "Parameterization with CSV Data",
        "JDBC Connectivity & Database Checks",
  ...
  return (
    <DarkModeProvider>
      ...
      <CourseStructuredData 
        ...
        description="Complete Manual Testing training covering test planning, test case design, defect management, SDLC/STLC processes, and QA best practices with guaranteed placement support."
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Manual Testing Training Program</span>
                </motion.div>
                ...
                >
                  Master the fundamentals of Manual Testing and Quality Assurance. Learn test case design, defect tracking, and QA best practices from industry experts.
                </motion.p>
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">50 Hrs.</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Manual Testing Training program is designed to provide you with comprehensive knowledge and hands-on experience in all aspects of manual software testing and quality assurance.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Test Planning", desc: "Learn comprehensive test strategies" },
                { icon: Code, title: "Test Case Design", desc: "Master effective test case creation" },
                { icon: TrendingUp, title: "Defect Management", desc: "Track and manage software defects" },
                { icon: Star, title: "SDLC & STLC", desc: "Understand development lifecycles" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <CourseTechnologySection courseSlug="manual-testing" />
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Manual Testing Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers SDLC/STLC processes, test design techniques, test case writing, defect management, Agile testing, tools like JIRA and TestRail, profile building, and interview preparation with real-world projects.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-2" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes. You get resume polishing, mock interviews, HR preparation, and interview opportunities through our hiring partners. Many learners secure QA positions within weeks of completion.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The course is offered in both formats. You also receive lifetime LMS access to recordings, notes, test case templates, and practical assignments.
                    </AccordionContent>
                  </AccordionItem>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Manual Testing Training.
              </p>
