...
const PythonDevelopmentTraining = () => {
  ...
  const courseHighlights = [
    ...
    },
    {
      ...
      icon: Award,
      description: "Earn industry-recognized certifications aligned with the Python curriculum.",
    },
    {
  ...
  // Python Development Curriculum Modules - 24 weeks (6 Months)
  const curriculumModules = [
    ...
    },
    {
      ...
      topics: [
        ...
        "Exception handling & unit testing with pytest"
      ]
    },
    {
      id: "module-3",
      ...
      topics: [
        ...
        "Algorithmic problem solving & time complexity"
      ]
    },
    {
      id: "module-4",
      ...
      duration: "2 Weeks",
      topics: [
        "SQL fundamentals with MySQL/PostgreSQL",
        "ORM with SQLAlchemy & Django ORM",
        "CRUD operations, joins & transactions"
      ]
    },
    {
      id: "module-5",
      ...
      duration: "3 Weeks",
      topics: [
        "MTV architecture, routing & views",
        "Templates, forms, validations & middleware",
        "Authentication, admin customization & security"
      ]
    },
    {
      id: "module-6",
    ...
    },
    {
      ...
      topics: [
        ...
        "Version control & CI/CD essentials",
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Python Programming Course - Python Development Training"
        description="Master Python programming from basics to advanced with Django, Flask, data structures, and real-world projects. Industry-recognized certification with placement support."
        keywords="python training, python programming course, python certification, learn python, python development, python for beginners, advanced python"
        canonical="/python-training"
        ogImage="/images/course images/python.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Python Programming Course"
        description="Complete Python programming training from basics to advanced, including Django, Flask, data structures, algorithms, and real-world project development."
        url="https://quastech.co.in/python-training"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/course images/python.png"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Python Development Training</span>
                </motion.div>
                ...
                >
                  Master Python programming from basics to advanced. Learn Django, Flask, data structures, APIs, and build powerful applications with hands-on projects.
                </motion.p>
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">8.5</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Python Development Training program helps you master Python fundamentals, advanced concepts, and modern frameworks to deliver production-ready applications with confidence.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Python Core Concepts", desc: "Master syntax, OOP, modules, and clean coding practices" },
                { icon: Code, title: "Web Frameworks", desc: "Build scalable backends with Django and Flask" },
                { icon: TrendingUp, title: "Data & Automation", desc: "Use Python for data processing, APIs, and automation scripts" },
                { icon: Star, title: "Project Portfolio", desc: "Create real-world applications that showcase your expertise" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in Python Development Training
                </span>
              </h2>
        ...
        <CourseTechnologySection courseSlug="python-training" />
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Python Development Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Python Development Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The curriculum covers Python fundamentals, object-oriented programming, data structures, database integration, Django, Flask APIs, data analysis with Pandas, automation scripting, deployment workflows, and capstone projects.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-2" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes. You receive resume-building support, mock interviews, HR preparation, and curated Python development opportunities through our hiring partners so you can transition into roles quickly.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Absolutely. Attend sessions online or at our centers and access lifetime LMS resources—video recordings, code repositories, cheat sheets, and assignments for every Python module.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The Python Development Training typically runs for 5–6 months with weekday or weekend batches. Expect 6–8 hours of guided sessions plus dedicated lab time and doubt-clearing support.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Freshers, working professionals, and career switchers are welcome. Basic logical thinking helps, and we start with programming fundamentals before moving into advanced Python concepts.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Python Development Training.
              </p>
