...
const RPATraining = () => {
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="RPA Training - Robotic Process Automation Course"
        description="Master Robotic Process Automation with UiPath, Automation Anywhere, and Blue Prism. Learn to automate business processes with industry certification and placement support."
        keywords="RPA course, robotic process automation, UiPath training, automation anywhere, blue prism, RPA certification, process automation training"
        canonical="/rpa"
        ogImage="/images/RAP-traning.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="RPA Training Course"
        description="Comprehensive Robotic Process Automation training covering UiPath, Automation Anywhere, Blue Prism, and enterprise automation best practices."
        url="https://quastech.co.in/rpa"
        duration="P3M"
        courseMode="blended"
        image="https://quastech.co.in/images/RAP-traning.png"
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">RPA Training</span>
                </motion.div>
                ...
                >
                  Master Robotic Process Automation (RPA) with UiPath, Automation Anywhere, and Blue Prism. Learn to automate business processes, reduce manual work, and transform organizational efficiency.
                </motion.p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the RPA Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers UiPath, Automation Anywhere, Blue Prism, process automation, bot development, workflows, exception handling, Orchestrator, and real-world RPA implementation projects.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to RPA bot workflows, video lectures, study materials, practice exercises, and automation projects.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 8-12 weeks. Classes are scheduled on weekdays/weekends with hands-on bot development, automation projects, and dedicated support for RPA concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No prior coding experience is required. RPA tools use visual workflows. Suitable for business analysts, IT professionals, and anyone interested in process automation.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
