...
const ReactTraining = () => {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    const whatsappMessage = `*React JS Development - Enquiry*
...
I'm interested in the React JS Development course. Please provide more details.`;
  ...
  const courseHighlights = [
    ...
    },
    {
      ...
      icon: Award,
      description: "Earn industry-recognized certifications aligned with the React curriculum.",
    },
    {
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="React JS Course - React Development Training"
        description="Master React.js with comprehensive training in components, hooks, Redux, React Router, and modern React development. Build dynamic web applications with 100% placement support."
        keywords="react course, reactjs training, react certification, react hooks, redux training, react developer course, frontend development"
        canonical="/react-course"
        ogImage="/images/course images/react.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="React JS Course"
        description="Complete React.js training covering components, hooks, state management with Redux, React Router, and modern React development practices."
        url="https://quastech.co.in/react-course"
        duration="P3M"
        courseMode="blended"
        image="https://quastech.co.in/images/course images/react.png"
      />
          ...
          <div className="relative z-10 w-full container mx-auto px-4 py-4">
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  Master React JS and build modern, dynamic web applications. Learn components, hooks, state management, Redux, and create interactive user interfaces with hands-on projects.
                </motion.p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our React JS Development program takes you from modern frontend fundamentals to building production-ready React applications with hands-on projects and expert mentorship.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Component Architecture", desc: "Design reusable, scalable UI components" },
                { icon: Code, title: "State Management", desc: "Master hooks, Context API, and Redux patterns" },
                { icon: TrendingUp, title: "Frontend Tooling", desc: "Work with Vite, TypeScript, and modern build tools" },
                { icon: Star, title: "Performance Optimization", desc: "Deliver lightning-fast React apps with best practices" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">
                  React JS Development Curriculum
                </span>
              </h2>
            </motion.div>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in React JS Development Training
                </span>
              </h2>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our React JS Development Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the React Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers React fundamentals, JSX, components, state management, hooks, Redux, React Router, API integration, performance optimization, testing, and building real-world React applications.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to React project source code, video lectures, study materials, coding exercises, and hands-on assignments.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 8-12 weeks. Classes are scheduled on weekdays/weekends with hands-on coding sessions, project building, and dedicated support for React development.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic HTML, CSS, and JavaScript knowledge is recommended. We provide a quick refresher and then progress to React concepts. Suitable for web developers and frontend enthusiasts.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our React JS Development Training.
              </p>
