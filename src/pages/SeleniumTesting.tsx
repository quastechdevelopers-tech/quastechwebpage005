...
const SeleniumTesting = () => {
  ...
  // Selenium Automation Testing Curriculum Modules
  const curriculumModules = [
    ...
    },
    {
      ...
      topics: [
        ...
        "Working with Text Boxes & Buttons"
      ]
    },
    {
      id: "module-4",
  ...
  return (
    <DarkModeProvider>
      ...
      <CourseStructuredData 
        name="Selenium Automation Testing Course"
        description="Complete Selenium Automation Testing training covering Selenium WebDriver, Java programming, TestNG framework, automation frameworks (POM, Data-Driven, Hybrid), CI/CD with Jenkins, and guaranteed placement support."
        url="https://quastech.co.in/selenium-testing"
        duration="P4M"
        courseMode="blended"
      ...
      <BreadcrumbStructuredData 
        items={[
          ...
          { name: "Selenium Testing", url: "/selenium-testing" }
        ]}
      />
            ...
            <div className="grid lg:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Selenium Automation Testing Program</span>
                </motion.div>
                ...
                >
                  Selenium Automation Testing Program
                </motion.h1>
                ...
                >
                  Master Selenium WebDriver and test automation frameworks. Build robust automation scripts and accelerate your career as a Test Automation Engineer.
                </motion.p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Selenium Automation Testing program is designed to provide you with comprehensive knowledge and hands-on experience in test automation using Selenium WebDriver and industry-standard frameworks.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Selenium WebDriver", desc: "Master automation with WebDriver" },
                { icon: Code, title: "Java Programming", desc: "Learn Java for test automation" },
                { icon: TrendingUp, title: "Test Frameworks", desc: "Build scalable automation frameworks" },
                { icon: Star, title: "CI/CD Integration", desc: "Integrate with Jenkins & DevOps" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Selenium Automation Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers Core Java, Selenium WebDriver, TestNG, automation frameworks (POM, Data-Driven, Hybrid), Maven, Jenkins CI/CD, API testing with REST Assured, Git version control, and interview preparation with real automation projects.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-2" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes. You get resume polishing, mock interviews, HR preparation, and interview opportunities through our hiring partners. Many automation engineers secure offers within weeks of completion.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The course is offered in both formats. You also receive lifetime LMS access to recordings, notes, automation scripts, framework code, and practice assignments.
                    </AccordionContent>
                  </AccordionItem>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Selenium Automation Training.
              </p>
