...
I am interested in booking a free counselling session. Please contact me at your earliest convenience.`;
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Taxation Training Course with Placement"
        description="Master Taxation with comprehensive training in Income Tax, Direct Tax Laws, TDS, GST, Tax Return Filing, Tax Planning, Tax Audit, Corporate Taxation, and Tax Advisory. Get hands-on experience with real tax cases and 100% placement assistance at QUASTECH."
        keywords="taxation course, income tax training, GST course, TDS training, tax return filing, tax planning, tax audit, corporate taxation, tax consultant certification, placement guarantee"
        canonical="/taxation"
        ogImage="/images/taxation/taxation.png"
        category="Non-IT Courses"
      />
      <CourseStructuredData 
        name="Taxation Training Course"
        description="Complete Taxation training covering Income Tax Fundamentals, Direct Tax Laws, TDS, GST, Tax Planning & Compliance, Tax Return Filing, Tax Audit, Corporate Taxation, and Tax Advisory Services with guaranteed placement support."
        url="https://quastech.co.in/taxation"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/taxation/taxation.png"
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Taxation</span>
                </motion.div>
                ...
                >
                  Master Taxation with comprehensive training in Income Tax, Direct Tax Laws, TDS, GST, Tax Planning, Tax Return Filing, and Corporate Taxation. Become a certified tax professional with expert guidance.
                </motion.p>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Taxation Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers income tax, GST (Goods and Services Tax), TDS, tax planning, tax filing, ITR preparation, tax compliance, tax laws, and practical taxation scenarios for businesses and individuals.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to video lectures, tax forms, filing tutorials, study materials, and practical taxation case studies.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 10-12 weeks. Classes are scheduled on weekdays/weekends with practical filing exercises, tax scenarios, and dedicated support for taxation concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">Who can join�do I need prior tax knowledge?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Basic knowledge of income and business operations is helpful. Suitable for accountants, tax professionals, business owners, finance students, and anyone interested in taxation.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
