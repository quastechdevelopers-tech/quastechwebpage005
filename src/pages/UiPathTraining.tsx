...
const UiPathTraining = () => {
  ...
  const modules = [
    { title: "UiPath Basics", topics: ["UiPath Studio", "Workflows", "Activities", "Selectors"] },
    { title: "Advanced RPA", topics: ["Orchestrator", "RE Framework", "Queue Management", "Exception Handling"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="UiPath Course - RPA Development" description="Master UiPath for robotic process automation." keywords="UiPath training, RPA development" canonical="/uipath-training" ogImage="/images/RAP-traning.png" category="IT Courses" />
      <CourseStructuredData name="UiPath Development" description="RPA automation with UiPath." url="https://quastech.co.in/uipath-training" duration="P3M" courseMode="blended" image="https://quastech.co.in/images/RAP-traning.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "UiPath", url: "/uipath-training" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><h1 className="text-5xl font-bold">UiPath Development</h1><p className="text-xl">Master robotic process automation</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
