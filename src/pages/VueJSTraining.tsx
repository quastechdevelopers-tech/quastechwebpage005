...
const VueJSTraining = () => {
  ...
  const modules = [
    { title: "Vue.js Fundamentals", topics: ["Vue Instance", "Components", "Templates", "Directives"] },
    { title: "Advanced Vue", topics: ["Vuex State Management", "Vue Router", "Composition API", "Vue 3 Features"] }
  ];

  return (
    <DarkModeProvider>
      <SEO title="Vue.js Course - Progressive JavaScript Framework Training" description="Master Vue.js framework with comprehensive training in components, Vuex, Vue Router, and modern Vue 3 development." keywords="vue js, vue.js training, vuex, vue router, javascript framework" canonical="/vue-js-training" ogImage="/images/front-end-dveleopment.png" category="IT Courses" />
      <CourseStructuredData name="Vue.js Development" description="Complete Vue.js framework training." url="https://quastech.co.in/vue-js-training" duration="P3M" courseMode="blended" image="https://quastech.co.in/images/front-end-dveleopment.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "Vue.js", url: "/vue-js-training" }]} />
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        <section className="relative w-full min-h-[600px] md:h-[600px] flex items-center overflow-hidden py-8 md:py-0" style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)' }}>
          ...
          <div className="relative z-10 container mx-auto px-4"><div className="text-white space-y-6"><Link to="/"><Home className="w-4 h-4 inline" /> Home</Link> / Vue.js<h1 className="text-5xl font-bold">Vue.js Development</h1><p className="text-xl">Build progressive web applications</p><Button className="bg-white text-blue-600">Enroll Now</Button></div></div>
        </section>
