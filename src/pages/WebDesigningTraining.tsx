...
const WebDesigningTraining = () => {
  ...
  // Web Designing with React Curriculum Modules - 20 weeks (5 Months)
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Web Designing Course - UI/UX Design Training"
        description="Become a professional web designer with training in HTML5, CSS3, JavaScript, Bootstrap, Responsive Design, and UI/UX principles. Build stunning websites with placement assistance."
        keywords="web designing course, UI UX training, HTML CSS course, responsive web design, web designer certification, frontend design training"
        canonical="/web-designing-training"
        ogImage="/images/front-end-dveleopment.png"
        category="IT Courses"
      />
      <CourseStructuredData 
        name="Web Designing Course"
        description="Professional web designing training covering HTML5, CSS3, JavaScript, Bootstrap, Responsive Design, UI/UX principles, and modern design tools."
        url="https://quastech.co.in/web-designing-training"
        duration="P3M"
        courseMode="blended"
        image="https://quastech.co.in/images/front-end-dveleopment.png"
      />
      <BreadcrumbStructuredData 
        items={[
          { name: "Home", url: "/" },
          { name: "Courses", url: "/#courses" },
          { name: "Web Designing Training", url: "/web-designing-training" }
        ]}
      />
            ...
            <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-white font-semibold">Web Designing Training</span>
                </motion.div>
                ...
                >
                  Master web designing and create stunning, user-friendly websites. Learn HTML, CSS, JavaScript, responsive design, UI/UX principles, and modern design tools to bring your creative vision to life.
                </motion.p>
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">5 Months</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Our Web Designing Training focuses on HTML5, CSS3, Bootstrap, responsive layouts, accessibility, and modern UI/UX practices to create stunning, user-friendly websites.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "Responsive Layouts", desc: "Build with Flexbox, Grid, and modern CSS" },
                { icon: Code, title: "Design Systems", desc: "Reusable components with Bootstrap & utility CSS" },
                { icon: TrendingUp, title: "Accessibility & SEO", desc: "Inclusive, performant, and search-friendly UIs" },
                { icon: Star, title: "Prototyping", desc: "Wireframes, style guides, and design handoff" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Key Highlights in Web Designing Training
                </span>
              </h2>
        ...
        <section className="py-8 md:py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">
                <span className="bg-gradient-to-r from-blue-600  to-orange-500 bg-clip-text text-transparent">
                  Tools & Technologies You'll Master in Web Designing
                </span>
              </h2>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                Clear, concise answers about our Web Designing Training—curriculum, format, placement, and more.
              </p>
            </motion.div>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    <AccordionTrigger className="px-6 py-5 text-left font-semibold hover:no-underline">
                      <span className="text-gray-900">What is included in the Web Designing Training Program?</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program covers HTML5, CSS3, responsive design, Bootstrap, JavaScript basics, jQuery, Figma/Adobe XD, UI/UX principles, animations, and building modern, professional websites.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-3" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Yes, both modes are available. You get lifetime LMS access to website templates, video tutorials, design resources, coding exercises, and project files.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 8-12 weeks. Classes are scheduled on weekdays/weekends with hands-on website building, design projects, and dedicated support for web design concepts.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5" className="group bg-white border border-blue-100 rounded-2xl mb-1 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      No prior coding experience is required. We start from basics and gradually build to professional web design. Perfect for beginners, designers, and creative enthusiasts.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who have transformed their careers with our Web Designing Training.
              </p>
